...
def einsum_attention(query: Tensor, key: Tensor, value: Tensor, time_steps: Tensor) -> Tensor:
    """
    Computes casual self attention, this isn't as efficient as flex attention but can use different masking without recompiling with end to end torch.compile
    """
